...
# 2 "mode/normal_mode.c" 2

# 1 "mode/../clock/clock.h" 1
...
# 4 "mode/../clock/clock.h" 2
# 20 "mode/../clock/clock.h"
...
# 3 "mode/normal_mode.c" 2

# 1 "mode/../controller/LCD/lcd.h" 1
...
# 5 "mode/normal_mode.c" 2

# 1 "mode/../controller/Luminosity/luminosity.h" 1
# 28 "mode/../controller/Luminosity/luminosity.h"
uint8_t readLum(void);
void get_luminosity(char *luminosity);
# 6 "mode/normal_mode.c" 2

# 1 "mode/../controller/Temperature/temperature.h" 1
# 14 "mode/../controller/Temperature/temperature.h"
uint8_t readTemperature(void);


void get_temperature(char *temperature);
# 7 "mode/normal_mode.c" 2

# 1 "mode/../state/state.h" 1




# 1 "C:\\Program Files\\Microchip\\xc8\\v2.50\\pic\\include\\c99\\stdbool.h" 1 3
# 5 "mode/../state/state.h" 2
# 26 "mode/../state/state.h"
typedef struct
{
...
void normal_mode_s1_handler() { set_mode(1); }

void normal_mode_s2_handler() {
  _s2_state = (_s2_state + 1) % (2 + 1);
  switch (_s2_state) {
  case 1:
    break;
  case 2:
